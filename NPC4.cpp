#include "NPC4.h"
npc4::npc4(float y, float _speed)
{
	texture.loadFromFile("Resources/npc4.png", sf::IntRect(0, 0, 34, 62));
	texture1.loadFromFile("Resources/npc4.png", sf::IntRect(0, 62, 34, 62));
...
void npc4::SetupAnimations()
{
	//right animation
	sf::Texture r1, r2, r3;
	r1.loadFromFile("Resources/npc4.png", sf::IntRect(0, 0, 34, 62));
	r2.loadFromFile("Resources/npc4.png", sf::IntRect(0, 62, 34, 62));
	r3.loadFromFile("Resources/npc4.png", sf::IntRect(0, 124, 34, 62));
